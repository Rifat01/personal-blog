...
@section('content')
  ...
  <div class="container">
      <div class="container">
          <h1 class="fcolor5" align="center"><br>Our Developers<br><img src="{{asset('/assets/img/line.gif')}}"></h1>
      </div>
                      ...
                      <div class="flip-box">
                          <div class="flip-box-inner">
                              <div class="flip-box-front">
                                  <img src="{{asset('/assets/img/service.jpg')}}" id="contact123" height="250px" width="100%" class="mx-auto d-block img-responsive ">
                              </div>
              ...
              <div class="card mb-4 shadow-sm">
                  ...
                  <div class="card-body">
                      <div class="flip-box">
                          <div class="flip-box-inner">
                              <div class="flip-box-front">
                                  <img src="{{asset('/assets/img/service.jpg')}}" id="contact123" height="250px" width="100%" class="mx-auto d-block">
                              </div>
                              <div class="flip-box-back font123 fcolor1">
