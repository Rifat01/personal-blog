<?php $__env->startSection('title'); ?> Author posts <?php $__env->stopSection(); ?>
                    ...
                    <table class="table">
                        ...
                        <?php $__currentLoopData = Auth::user()->posts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo e(route('postEdit', $post->id)); ?>" class="btn btn-warning">Edit</a>
                                    <form method="POST" id="deletePost-<?php echo e($post->id); ?>" action="<?php echo e(route('deletePost', $post->id)); ?>"><?php echo csrf_field(); ?></form>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form method="POST" id="deletePost-<?php echo e($post->id); ?>" action="<?php echo e(route('deletePost', $post->id)); ?>"><?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\personal-blog\resources\views/author/posts.blade.php ENDPATH**/ ?>