<?php $__env->startSection('title'); ?> user comments <?php $__env->stopSection(); ?>
        ...
        <div class="table-responsive">
            <table class="table">
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteCommentModal-<?php echo e($comment->id); ?>">X</button>
                    </td>
                </tr>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form method="POST" id="deletePost-<?php echo e($comment->id); ?>" action="<?php echo e(route('deleteComment', $comment->id)); ?>"><?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\personal-blog\resources\views/user/comments.blade.php ENDPATH**/ ?>