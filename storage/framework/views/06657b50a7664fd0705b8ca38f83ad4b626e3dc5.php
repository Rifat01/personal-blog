            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form action="<?php echo e(route('adminPostEditPost', $post->id )); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-8">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\personal-blog\resources\views/admin/editPost.blade.php ENDPATH**/ ?>